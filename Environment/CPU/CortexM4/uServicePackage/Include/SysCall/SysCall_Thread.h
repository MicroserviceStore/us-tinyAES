...
/**
 * Initialise a Thread Pool to use with PThreads
 * See SYS_INITIALISE_THREAD_POOL() for details.
 */
#define PTHREAD_CREATE_THREADPOOL(_retVal, _maxThreadCount) \
            SYS_INITIALISE_THREAD_POOL(_retVal, _maxThreadCount)
...
/**
 * Initialise a Thread Sync Pool to use with PThreads
 * See SYS_INITIALISE_THREADSYNC_POOL() for details.
 */
#define PTHREAD_CREATE_THREADSYNCPOOL(_retVal, _maxThreadSyncCount) \
            SYS_INITIALISE_THREADSYNC_POOL(_retVal, _maxThreadSyncCount)
