...
#ifndef SIM_CPUCORE_NAME
#error "SIM_CPUCORE_NAME not defined. (Must be a string name matches CPU Core Name up to 15 character)"
#endif

#ifndef SIM_EXEC_INDEX
#error "SIM_EXEC_INDEX not defined. (Each Exec has a unique index between 0 to 15)"
#endif
}

namespace UserAppSimulator
{
    ...
    public ref class MainForm : public System::Windows::Forms::Form
    {
         ...
         */
        private: void simulatorThread(void)
        {
            Thread::Sleep(1000);
        ...
        MainForm(void)
        {
            ...
            Thread^ applicationThread = gcnew Thread(gcnew ThreadStart(this, &MainForm::simulatorThread));
        ...
        void InitializeComponent(void)
        {
            ...
            this->toolStripLabel1->Text = L"Simulator";
            // 
            // toolStripSeparator3
            // 
            ...
            this->Text = L"User Application Simulator";
